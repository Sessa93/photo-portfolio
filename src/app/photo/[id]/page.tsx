  ...
  return (
    <main className="min-h-screen bg-[#0c0c0c] animate-fade-in">
      ...
      <div className="fixed top-0 left-0 z-20" style={{ padding: "24px" }}>
        ...
        >
          <span className="inline-flex items-center justify-center rounded-md border border-neutral-700 bg-neutral-900 transition-all group-hover:border-neutral-500 group-hover:bg-neutral-800" style={{ width: "32px", height: "32px" }}>
            <svg
      ...
      <div className="flex min-h-screen flex-col lg:flex-row">
        {/* Left: Image */}
        <div className="relative flex items-center justify-center lg:w-[60%] lg:sticky lg:top-0 lg:h-screen" style={{ padding: "24px" }}>
        ...
        {/* Right: Details */}
        <div className="flex flex-col px-8 py-16 sm:px-12 lg:w-[40%] lg:px-16 lg:h-screen lg:overflow-y-auto" style={{ paddingTop: "24px", paddingBottom: "24px" }}>
          ...
          {/* Location */}
          {photo.location && (
            <p style={{ marginTop: "10px" }} className="flex items-center gap-2 text-sm text-neutral-500 italic">
          ...
          {/* Description */}
          <p style={{ marginTop: "3px", marginBottom: "3px" }} className="text-base italic leading-[2.5] text-neutral-400">
            {photo.description}
          </p>
