...
function DetailRow({ label, value }: { label: string; value?: string | null }) {
  ...
  return (
    <div>
      <span className="block text-[11px] uppercase tracking-[0.25em] text-neutral-700">
        {label}
      </span>
  ...
  return (
    <main className="min-h-screen bg-[#0c0c0c] animate-fade-in">
      ...
      <div className="flex min-h-screen flex-col lg:flex-row">
        ...
        {/* Right: Details */}
        <div
          className="flex flex-col px-8 py-16 sm:px-12 lg:w-[40%] lg:px-16 lg:h-screen lg:overflow-y-auto"
